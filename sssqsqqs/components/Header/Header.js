      ...
      <Toolbar className={classes.toolbar}>
        ...
        >
          ...
          <Typography variant="body2" weight={"bold"} className={classes.profileLabel}>
            {/* { managementValue.currentUser.fullName } */} KARBOUL Firas
            <IconButton onClick={() => console.log(managementValue.currentUser.fullName)}>OK</IconButton>
          </Typography>
        </Typography>
        <Menu
          id="mail-menu"
