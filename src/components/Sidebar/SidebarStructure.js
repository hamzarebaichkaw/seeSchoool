...
const structure = [
    ...
    { id: 50, label: 'Cours et exercices', link: '/app/cours', icon: <LibraryIcon /> },
    { id: 51, label: 'Emploi', link: '/app/emploi', icon: <BorderAllIcon /> },
    { id: 52, label: 'Notifications', link: '/app/notification', icon: <NotificationsNoneIcon /> },
    { id: 53, label: 'Notes', link: '/app/notes', icon: <CheckBoxIcon /> },
    { id: 54, label: 'Events', link: '/app/events', icon: <SupportIcon /> },
    { id: 55, label: 'Absences', link: '/app/absence', icon: <ScheduleIcon /> },
    { id: 56, label: 'Homework', link: '/app/homework', icon: <CreateIcon /> },
    { id: 57, label: 'Support', link: '/app/support', icon: <FAQIcon /> },
    { id: 58, label: 'Blogs', link: '/app/blogs', icon: <MenuBookIcon /> },
    { id: 58, label: 'E-Learning (Live)', link: '/app/E-learning', icon: <LiveTvIcon /> },
